...
fn get_building_scale(building_type: BuildingType, rng: &mut ChaCha8Rng) -> Vector3<f32> {
    match building_type {
        BuildingType::IzbaDerevo => Vector3::new(
            rng.gen_range(5.0..8.0),
            rng.gen_range(3.0..4.5),
            rng.gen_range(6.0..10.0),
        ),
        BuildingType::DomKirpich => Vector3::new(
            rng.gen_range(8.0..12.0),
            rng.gen_range(4.0..8.0),
            rng.gen_range(10.0..15.0),
        ),
        BuildingType::KhrushchyovkaPyat => Vector3::new(
            rng.gen_range(15.0..25.0),
            rng.gen_range(15.0..20.0),
            rng.gen_range(30.0..50.0),
        ),
        BuildingType::PanelnyyDom => Vector3::new(
            rng.gen_range(15.0..20.0),
            rng.gen_range(25.0..35.0),
            rng.gen_range(40.0..60.0),
        ),
        BuildingType::Sklad => Vector3::new(
            rng.gen_range(15.0..30.0),
            rng.gen_range(6.0..10.0),
            rng.gen_range(30.0..50.0),
        ),
        BuildingType::Pilorama => Vector3::new(20.0, 8.0, 40.0),
        BuildingType::Zavodskoi => Vector3::new(
            rng.gen_range(30.0..50.0),
            rng.gen_range(10.0..20.0),
            rng.gen_range(40.0..80.0),
        ),
        BuildingType::ShakhtaVhod => Vector3::new(15.0, 8.0, 20.0),
        BuildingType::AZS => Vector3::new(10.0, 4.0, 10.0),
        BuildingType::RemontBaza => Vector3::new(15.0, 6.0, 20.0),
        BuildingType::Most => Vector3::new(5.0, 3.0, 30.0),
        BuildingType::Kolodets => Vector3::new(2.0, 1.5, 2.0),
        BuildingType::ZaborDerevo => Vector3::new(0.2, 1.5, 2.0),
        BuildingType::DorZnak => Vector3::new(0.1, 2.0, 0.5),
        BuildingType::StolbElektr => Vector3::new(0.3, 8.0, 0.3),
        BuildingType::Konteyner => Vector3::new(2.5, 2.5, 6.0),
    }
}
