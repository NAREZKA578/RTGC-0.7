...
impl Chunk {
    ...
    pub fn distance_to(&self, camera_pos: Vector3<f32>) -> f32 {
        self.bounding_sphere_center.distance(&camera_pos)
    }
...
pub fn generate_chunk_mesh(data: &ChunkData, lod_level: u32) -> (Vec<TerrainVertex>, Vec<u32>) {
    ...
    for z in 0..resolution {
        for x in 0..resolution {
            let gx = (x * stride) as f32;
            let gz = (z * stride) as f32;
            ...
            let splat = data.splatmap[z * stride * HEIGHTMAP_RESOLUTION as usize + x * stride];
