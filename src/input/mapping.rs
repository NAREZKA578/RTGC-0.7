...
use winit::keyboard::{KeyCode, Key, NamedKey};
...
impl InputAction {
    ...
    pub fn default_key_code(&self) -> Option<KeyCode> {
        match self {
            ...
            InputAction::FirePrimary => Some(KeyCode::MouseLeft),
            InputAction::FireSecondary => Some(KeyCode::MouseRight),
...
impl InputMapping {
    ...
    fn parse_key_code(&self, s: &str) -> Result<KeyCode, String> {
        ...
        match s {
            ...
            "MouseLeft" => Ok(KeyCode::MouseLeft),
            "MouseRight" => Ok(KeyCode::MouseRight),
