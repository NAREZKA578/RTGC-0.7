...
use super::settlement::{Settlement, SettlementType, BuildingType};
...
impl MissionGenerator {
    ...
    pub fn generate_mission(&mut self, player_pos: Vector3<f32>) -> Option<Mission> {
        ...
        let base_reward = (cargo_type.reward_per_km() * distance_km.max(1.0)) as i32;
